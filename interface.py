...
def fetch_recipe_info(url, name):
    ...
    print('First, we\'ll fetch the recipe information for you. Sit tight, this might take a minute or two. This will be provided below, as well as in a document for your reference later on.')
...
def main():
    ...
    while nq:
        ...
        while not cont:
            cont = input(
                'Would you like to continue applying transformations? ([y]es/[n]o): ').lower()
