...
nonVegetarian = {
 ...
 'sweet potatoes':'cubed chicken breats',
 'sweet potato':'cubed chicken breats',
...
replacements = {
 ...
 'baked good':['1 jar (2 cups) ready-to-use mincemeat', 'Ensure that you stir mincemeat with dry ingredients.'],
 'noodles':['2 cups cubed beef', 'Cook beef throughly and then combine with noodles.'],
 'romaine lettuce':['2 cups grilled cubed chicken', 'Combine grilled chicken with other ingredients.'],
 'soy sauce':['2 cups cubed beef', 'Cook beef thoroughly and then combine at the end.'],
 'cheese':['1 pound ground beef', 'Cook beef until browned. Combine.'],
 'bread':['1/2 pound diced chicken sausage', 'Fry until browned.'],
 'potatoes':['1/2 pound cubed beef', 'Cook beef thoroughly and then combine with potatoes'],
 'zucchini':['1/2 pound cubed beef', 'Cook beef thoroughly and then combine with zucchini']
}
...
def nonVegChecker(recipe_info):
    lst = list(nonVegetarian.keys())
    all_matches = [ ]
    for i in recipe_info['ingredients']:
...
def helper(recipe_info, chosen_dict):
    ...
    if chosen_dict == 'vegetarian':
        chosen_dict = vegetarian
    if chosen_dict == 'nonVegetarian':
        chosen_dict = nonVegetarian
